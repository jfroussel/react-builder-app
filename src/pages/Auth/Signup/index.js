...
const Signup = props => {
    ...
    const submitButton = email === '' || password === '' || password !== passwordConfirm
    ?  <Button type="submit" disabled variant="outlined">Register</Button> :  <Button type="submit"  variant="outlined">Register</Button>
        ...
        <Container className={classes.container}>
            <Grid container >
                <Grid item container direction="column" xs>
                    <Typography variant="h5" className="pb-5">Register</Typography>
